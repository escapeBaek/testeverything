    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `I got ${((endTime - startTime) || 0).toFixed(2)} ms on the Audio Reaction Time Test! Can you beat me?`,
  ...
  const renderContent = () => {
    switch (phase) {
      case 'waiting':
        return (
          <div className="text-center">
            <p className="text-2xl text-gray-700 mb-6">Click the button below when you hear the sound.</p>
            <button
              onClick={startTest}
      ...
      case 'ready':
        return (
          <div className="text-center">
            <p className="text-3xl font-bold text-yellow-600 animate-pulse">Wait for Sound...</p>
          </div>
        );
      case 'go':
        return (
      ...
      case 'too-early':
        return (
          <div className="text-center">
            ...
            <p className="text-2xl text-gray-700 mb-8">You clicked before the sound played.</p>
            <button
              onClick={startTest}
              className="px-8 py-4 bg-purple-600 text-white text-xl font-bold rounded-full shadow-lg hover:bg-purple-700 transition duration-300"
            >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 p-8 font-sans text-white flex items-center justify-center">
      <div className="max-w-2xl w-full mx-auto bg-white rounded-2xl shadow-xl p-8 mt-12 text-gray-800">
        <h1 className="text-5xl font-bold text-center mb-8">Audio Reaction Time Test</h1>
        {renderContent()}
      ...
      <audio ref={audioRef} src="/sounds/beep.mp3" preload="auto"></audio>
    </div>
  );
};
